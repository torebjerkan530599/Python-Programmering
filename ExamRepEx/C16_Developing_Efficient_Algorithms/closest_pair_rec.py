...
# alternative approach, only printing distance # import math if it has not been done
...
# alternative approach, printing distance and points # import math if it has not been done
