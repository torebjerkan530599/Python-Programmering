...
# løsningen forutsetter at koorinatsystemet er i skjermkoordinater der X øker mot høyre, og Y øker nedover
...
''' 
# for your convenience if you don't want to type:
x1 = 9
y1 = 1.3
width1 = 10
height1 = 35.3 
