#Test Clock
from solution_clock import solution_clock
import unittest

class Test_Clock(unittest.TestCase):

    def setUp(self): # RUNS BEFORE EACH TEST!
        self.__clock = solution_clock()
